                ...
                (function (a) {
                    ...
                    a.Tableau = a.inherit({
                        initialize: function () {
                            ...
                            var d = this.columns.get(b);
                            d || (d = new a.HashSet, this.columns.set()), d.add(c)
                        }, addRow: function (b, c) {
                            a.trace && a.fnenterprint("addRow: " + b + ", " + c), this.rows.set(), c.terms.each(function (a) {
                    ...
                    a.SimplexSolver = a.inherit({
                        "extends": a.Tableau, initialize: function () {
                            a.Tableau.call(this), this._stayMinusErrorVars = [], this._stayPlusErrorVars = [], this._errorVars = new a.HashTable, this._markerVars = new a.HashTable, this._objective = new a.ObjectiveVariable({name: "Z"}), this._editVarMap = new a.HashTable, this._editVarList = [], this._slackCounter = 0, this._artificialCounter = 0, this._dummyCounter = 0, this.autoSolve = !0, this._fNeedsSolving = !1, this._optimizeCount = 0, this.rows.set(), this._stkCedcns = [0], a.trace && a.traceprint("objective expr == " + this.rows.get(this._objective))
                            ...
                            if (d = d[0], this.tryAddingDirectly(e) || this.addWithArtificialVariable(e), this._fNeedsSolving = !0, b.isEditConstraint) {
                                ...
                                this._editVarMap.set(), this._editVarList[f] = {v: b.variable, info: i}
                            }
                            ...
                            if (k.each(function (a, b) {
                                ...
                                if (a.trace && a.traceprint("Inequality, adding slack"), ++this._slackCounter, g = new a.SlackVariable({
                                    ...
                                    prefix: "s"
                                }), f.setVariable(g, -1), this._markerVars.set(), !b.required) {
                                ...
                                prefix: "d"
                            }), f.setVariable(h, 1), this._markerVars.set(), a.trace && a.traceprint("Adding dummyVar == d" + this._dummyCounter) else {
                                a.trace && a.traceprint("Equality, not required"), ++this._slackCounter, j = new a.SlackVariable({
                                    ...
                                    value: this._slackCounter,
                                    prefix: "em"
                                }), f.setVariable(j, -1), f.setVariable(i, 1), this._markerVars.set()
                                var l = this.rows.get(this._objective)
                            ...
                            d || (d = new a.HashSet, this._errorVars.set()), d.add(c)
                        }
                    })
                }(this.c || module.parent.exports || {}), function (a) {
                    "use strict";
